...
$.extend( Datepicker.prototype, {
	...
	_selectDay: function( id, month, year, td ) {
		...
		inst = this._getInst( target[ 0 ] );
		inst.selectedDay = inst.currentDay = $( "a span", td ).html();
	...
	_generateHTML: function( inst ) {
				...
				for ( dRow = 0; dRow < numRows; dRow++ ) { // create date picker rows
					...
					for ( dow = 0; dow < 7; dow++ ) { // create date picker days
						...
						tbody += "<td class='" +
							...
							"' href='#'><span class='date' role='date-btn' data-value='"+printDate.getDate()+"'>" + printDate.getDate() + "</span></a>" ) ) + "</td>"; // display selectable date
		...
		html += '<div class="d-flex justify-content-center border-top py-2">';
		html += '<a href="javascript:;" class="font-weight-bold text-green dob__calculator-btn" role="tw-dob-btn">輸入民國轉換西元</a>';
		html += '</div>';
	...
	_generateMonthYearHeader: function( inst, drawMonth, drawYear, minDate, maxDate,
		...
		if ( secondary || !changeMonth ) {
			monthHtml += "<span class='ui-datepicker-month ml-2 custom-select'>" + monthNames[ drawMonth ] + "</span>";
		} else {
			inMinYear = ( minDate && minDate.getFullYear() === drawYear );
			inMaxYear = ( maxDate && maxDate.getFullYear() === drawYear );
			monthHtml += "<select class='ui-datepicker-month ml-2 custom-select' data-handler='selectMonth' data-event='change'>";
		...
		if ( !inst.yearshtml ) {
			...
			if ( secondary || !changeYear ) {
				html += "<span class='ui-datepicker-year mr-2 custom-select'>" + drawYear + "</span>";
			} else {
				...
				inst.yearshtml += "<select class='ui-datepicker-year custom-select mr-2' data-handler='selectYear' data-event='change'>";
		...
		// html += '<span class="mx-2">'+this._get( inst, "yearSuffix" ) +'</span>';
